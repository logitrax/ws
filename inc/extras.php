...
function workscout_license_admin_notice(){
            ...
            if(!b372b0Base::CheckWPPlugin( $licenseKey, $liceEmail, $licenseMessage, $responseObj, $templateDir."/style.css")){            
            ob_start();
...
function workscout_body_classes( $classes ) {
    ...
    if(is_user_logged_in()){
        $classes[] = 'ws-user-logged-in';
    } else {
        $classes[] = 'ws-user-logged-out';
    }
...
function workscout_material_icons(){
  $icons = array(
    "icon-material-outline-dashboard","icon-material-outline-arrow-back","icon-material-outline-arrow-forward","icon-material-outline-arrow-right-alt","icon-material-outline-gavel","icon-material-baseline-mail-outline","icon-material-baseline-notifications-none","icon-material-baseline-star-border","icon-material-outline-access-alarm","icon-material-outline-access-time","icon-material-outline-account-balance-wallet","icon-material-outline-account-balance","icon-material-outline-account-circle","icon-material-outline-add-a-photo","icon-material-outline-add-circle-outline","icon-material-outline-add-location","icon-material-outline-add-photo-alternate","icon-material-outline-add-shopping-cart","icon-material-outline-add","icon-material-outline-alarm-add","icon-material-outline-alarm-off","icon-material-outline-alarm-on","icon-material-outline-alarm","icon-material-outline-announcement","icon-material-outline-archive","icon-material-outline-arrow-drop-down","icon-material-outline-arrow-drop-up","icon-material-outline-arrow-left","icon-material-outline-arrow-right","icon-material-outline-assessment","icon-material-outline-assignment","icon-material-outline-attach-file","icon-material-outline-autorenew","icon-material-outline-battery-charging-full","icon-material-outline-beach-access","icon-material-outline-book","icon-material-outline-bookmark-border","icon-material-outline-bookmarks","icon-material-outline-broken-image","icon-material-outline-brush","icon-material-outline-bug-report","icon-material-outline-business-center","icon-material-outline-business","icon-material-outline-cake","icon-material-outline-check-circle","icon-material-outline-check","icon-material-outline-cloud","icon-material-outline-code","icon-material-outline-compare-arrows","icon-material-outline-computer","icon-material-outline-contact-support","icon-material-outline-credit-card","icon-material-outline-crop-original","icon-material-outline-date-range","icon-material-outline-delete","icon-material-outline-description","icon-material-outline-desktop-mac","icon-material-outline-desktop-windows","icon-material-outline-directions-car","icon-material-outline-dns","icon-material-outline-drafts","icon-material-outline-email","icon-material-outline-explore","icon-material-outline-extension","icon-material-outline-face","icon-material-outline-favorite-border","icon-material-outline-favorite","icon-material-outline-feedback","icon-material-outline-file-copy","icon-material-outline-filter-none","icon-material-outline-find-in-page","icon-material-outline-fingerprint","icon-material-outline-flight","icon-material-outline-flip-to-back","icon-material-outline-flip-to-front","icon-material-outline-folder-shared","icon-material-outline-folder","icon-material-outline-format-quote","icon-material-outline-format-shapes","icon-material-outline-forum","icon-material-outline-free-breakfast","icon-material-outline-gps-fixed","icon-material-outline-group","icon-material-outline-help-outline","icon-material-outline-highlight-off","icon-material-outline-history","icon-material-outline-home","icon-material-outline-hotel","icon-material-outline-https","icon-material-outline-info","icon-material-outline-input","icon-material-outline-insert-photo","icon-material-outline-keyboard-arrow-down","icon-material-outline-keyboard-arrow-left","icon-material-outline-keyboard-arrow-right","icon-material-outline-keyboard-arrow-up","icon-material-outline-language","icon-material-outline-launch","icon-material-outline-layers","icon-material-outline-library-add","icon-material-outline-library-books","icon-material-outline-local-atm","icon-material-outline-local-offer","icon-material-outline-location-city","icon-material-outline-location-off","icon-material-outline-location-on","icon-material-outline-lock-open","icon-material-outline-lock","icon-material-outline-loyalty","icon-material-outline-map","icon-material-outline-message","icon-material-outline-monetization-on","icon-material-outline-money","icon-material-outline-mouse","icon-material-outline-movie","icon-material-outline-my-location","icon-material-outline-note-add","icon-material-outline-notifications-active","icon-material-outline-notifications-off","icon-material-outline-notifications","icon-material-outline-outlined-flag","icon-material-outline-person-pin","icon-material-outline-photo-library","icon-material-outline-photo-size-select-actual","icon-material-outline-picture-as-pdf","icon-material-outline-power-settings-new","icon-material-outline-print","icon-material-outline-question-answer","icon-material-outline-rate-review","icon-material-outline-redo","icon-material-outline-reorder","icon-material-outline-restaurant","icon-material-outline-room","icon-material-outline-save-alt","icon-material-outline-school","icon-material-outline-search","icon-material-outline-settings-input-component","icon-material-outline-settings","icon-material-outline-shopping-cart","icon-material-outline-speaker-notes","icon-material-outline-star-border","icon-material-outline-star","icon-material-outline-supervisor-account","icon-material-outline-text-fields","icon-material-outline-textsms","icon-material-outline-thumb-down","icon-material-outline-thumb-up","icon-material-outline-undo","icon-material-outline-visibility","icon-material-outline-watch","icon-material-outline-wb-incandescent","icon-material-outline-where-to-vote",
    );	
    return $icons;
}
...
function workscout_feather_icons(){
  $icons = array(
        'icon-feather-activity', 'icon-feather-airplay', 'icon-feather-alert-circle', 'icon-feather-alert-octagon', 'icon-feather-alert-triangle', 'icon-feather-align-center', 'icon-feather-align-justify', 'icon-feather-align-left', 'icon-feather-align-right', 'icon-feather-anchor', 'icon-feather-aperture', 'icon-feather-archive', 'icon-feather-arrow-down', 'icon-feather-arrow-down-circle', 'icon-feather-arrow-down-left', 'icon-feather-arrow-down-right', 'icon-feather-arrow-left', 'icon-feather-arrow-left-circle', 'icon-feather-arrow-right', 'icon-feather-arrow-right-circle', 'icon-feather-arrow-up', 'icon-feather-arrow-up-circle', 'icon-feather-arrow-up-left', 'icon-feather-arrow-up-right', 'icon-feather-at-sign', 'icon-feather-award', 'icon-feather-bar-chart', 'icon-feather-bar-chart-2', 'icon-feather-battery', 'icon-feather-battery-charging', 'icon-feather-bell', 'icon-feather-bell-off', 'icon-feather-bluetooth', 'icon-feather-bold', 'icon-feather-book', 'icon-feather-book-open', 'icon-feather-bookmark', 'icon-feather-box', 'icon-feather-briefcase', 'icon-feather-calendar', 'icon-feather-camera', 'icon-feather-camera-off', 'icon-feather-cast', 'icon-feather-check', 'icon-feather-check-circle', 'icon-feather-check-square', 'icon-feather-chevron-down', 'icon-feather-chevron-left', 'icon-feather-chevron-right', 'icon-feather-chevron-up', 'icon-feather-chevrons-down', 'icon-feather-chevrons-left', 'icon-feather-chevrons-right', 'icon-feather-chevrons-up', 'icon-feather-chrome', 'icon-feather-circle', 'icon-feather-clipboard', 'icon-feather-clock', 'icon-feather-cloud', 'icon-feather-cloud-drizzle', 'icon-feather-cloud-lightning', 'icon-feather-cloud-off', 'icon-feather-cloud-rain', 'icon-feather-cloud-snow', 'icon-feather-code', 'icon-feather-codepen', 'icon-feather-codesandbox', 'icon-feather-coffee', 'icon-feather-columns', 'icon-feather-command', 'icon-feather-compass', 'icon-feather-copy', 'icon-feather-corner-down-left', 'icon-feather-corner-down-right', 'icon-feather-corner-left-down', 'icon-feather-corner-left-up', 'icon-feather-corner-right-down', 'icon-feather-corner-right-up', 'icon-feather-corner-up-left', 'icon-feather-corner-up-right', 'icon-feather-cpu', 'icon-feather-credit-card', 'icon-feather-crop', 'icon-feather-crosshair', 'icon-feather-database', 'icon-feather-delete', 'icon-feather-disc', 'icon-feather-divide', 'icon-feather-divide-circle', 'icon-feather-divide-square', 'icon-feather-dollar-sign', 'icon-feather-download', 'icon-feather-download-cloud', 'icon-feather-dribbble', 'icon-feather-droplet', 'icon-feather-edit', 'icon-feather-edit-2', 'icon-feather-edit-3', 'icon-feather-external-link', 'icon-feather-eye', 'icon-feather-eye-off', 'icon-feather-facebook', 'icon-feather-fast-forward', 'icon-feather-feather', 'icon-feather-figma', 'icon-feather-file', 'icon-feather-file-minus', 'icon-feather-file-plus', 'icon-feather-file-text', 'icon-feather-film', 'icon-feather-filter', 'icon-feather-flag', 'icon-feather-folder', 'icon-feather-folder-minus', 'icon-feather-folder-plus', 'icon-feather-framer', 'icon-feather-frown', 'icon-feather-gift', 'icon-feather-git-branch', 'icon-feather-git-commit', 'icon-feather-git-merge', 'icon-feather-git-pull-request', 'icon-feather-github', 'icon-feather-gitlab', 'icon-feather-globe', 'icon-feather-grid', 'icon-feather-hard-drive', 'icon-feather-hash', 'icon-feather-headphones', 'icon-feather-heart', 'icon-feather-help-circle', 'icon-feather-hexagon', 'icon-feather-home', 'icon-feather-image', 'icon-feather-inbox', 'icon-feather-info', 'icon-feather-instagram', 'icon-feather-italic', 'icon-feather-key', 'icon-feather-layers', 'icon-feather-layout', 'icon-feather-life-buoy', 'icon-feather-link', 'icon-feather-link-2', 'icon-feather-linkedin', 'icon-feather-list', 'icon-feather-loader', 'icon-feather-lock', 'icon-feather-log-in', 'icon-feather-log-out', 'icon-feather-mail', 'icon-feather-map', 'icon-feather-map-pin', 'icon-feather-maximize', 'icon-feather-maximize-2', 'icon-feather-meh', 'icon-feather-menu', 'icon-feather-message-circle', 'icon-feather-message-square', 'icon-feather-mic', 'icon-feather-mic-off', 'icon-feather-minimize', 'icon-feather-minimize-2', 'icon-feather-minus', 'icon-feather-minus-circle', 'icon-feather-minus-square', 'icon-feather-monitor', 'icon-feather-moon', 'icon-feather-more-horizontal', 'icon-feather-more-vertical', 'icon-feather-mouse-pointer', 'icon-feather-move', 'icon-feather-music', 'icon-feather-navigation', 'icon-feather-navigation-2', 'icon-feather-octagon', 'icon-feather-package', 'icon-feather-paperclip', 'icon-feather-pause', 'icon-feather-pause-circle', 'icon-feather-pen-tool', 'icon-feather-percent', 'icon-feather-phone', 'icon-feather-phone-call', 'icon-feather-phone-forwarded', 'icon-feather-phone-incoming', 'icon-feather-phone-missed', 'icon-feather-phone-off', 'icon-feather-phone-outgoing', 'icon-feather-pie-chart', 'icon-feather-play', 'icon-feather-play-circle', 'icon-feather-plus', 'icon-feather-plus-circle', 'icon-feather-plus-square', 'icon-feather-pocket', 'icon-feather-power', 'icon-feather-printer', 'icon-feather-radio', 'icon-feather-refresh-ccw', 'icon-feather-refresh-cw', 'icon-feather-repeat', 'icon-feather-rewind', 'icon-feather-rotate-ccw', 'icon-feather-rotate-cw', 'icon-feather-rss', 'icon-feather-save', 'icon-feather-scissors', 'icon-feather-search', 'icon-feather-send', 'icon-feather-server', 'icon-feather-settings', 'icon-feather-share', 'icon-feather-share-2', 'icon-feather-shield', 'icon-feather-shield-off', 'icon-feather-shopping-bag', 'icon-feather-shopping-cart', 'icon-feather-shuffle', 'icon-feather-sidebar', 'icon-feather-skip-back', 'icon-feather-skip-forward', 'icon-feather-slack', 'icon-feather-slash', 'icon-feather-sliders', 'icon-feather-smartphone', 'icon-feather-smile', 'icon-feather-speaker', 'icon-feather-square', 'icon-feather-star', 'icon-feather-stop-circle', 'icon-feather-sun', 'icon-feather-sunrise', 'icon-feather-sunset', 'icon-feather-table', 'icon-feather-tablet', 'icon-feather-tag', 'icon-feather-target', 'icon-feather-terminal', 'icon-feather-thermometer', 'icon-feather-thumbs-down', 'icon-feather-thumbs-up', 'icon-feather-toggle-left', 'icon-feather-toggle-right', 'icon-feather-tool', 'icon-feather-trash', 'icon-feather-trash-2', 'icon-feather-trello', 'icon-feather-trending-down', 'icon-feather-trending-up', 'icon-feather-triangle', 'icon-feather-truck', 'icon-feather-tv', 'icon-feather-twitch', 'icon-feather-twitter', 'icon-feather-type', 'icon-feather-umbrella', 'icon-feather-underline', 'icon-feather-unlock', 'icon-feather-upload', 'icon-feather-upload-cloud', 'icon-feather-user', 'icon-feather-user-check', 'icon-feather-user-minus', 'icon-feather-user-plus', 'icon-feather-user-x', 'icon-feather-users', 'icon-feather-video', 'icon-feather-video-off', 'icon-feather-voicemail', 'icon-feather-volume', 'icon-feather-volume-1', 'icon-feather-volume-2', 'icon-feather-volume-x', 'icon-feather-watch', 'icon-feather-wifi', 'icon-feather-wifi-off', 'icon-feather-wind', 'icon-feather-x', 'icon-feather-x-circle', 'icon-feather-x-octagon', 'icon-feather-x-square', 'icon-feather-youtube', 'icon-feather-zap', 'icon-feather-zap-off', 'icon-feather-zoom-in', 'icon-feather-zoom-out',
  );
  return $icons;
}
